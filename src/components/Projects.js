    ...
    <section className='bg-primary text-white px-5 py-32' id='projects'>
        <div className='container mx-auto grid md:grid-cols-2 items-center md:justify-between'>
            <div className='about-info mb-5'>
                ...
                <p className='pb-5'>These are some of my best projects. I have build these with React, MERN, and VanillaCSS. Check them out!</p>
            </div>
        ...
        {projects.map((project, i) => {
            ...
            <div className="relative" key={i}>
                ...
                <p className="py-5 text-center font-bold px-2 text-white">{project.desc}</p>
                    ...
                    <div className="mx-auto"><a href={project.live} className="px-5 py-2 bg-blue-500 hover:bg-blue-600 mr-5 font-bold">Live</a>
                        <a href={project.code} className="px-5 py-2 bg-blue-700 hover:bg-blue-800 font-bold">Code</a>
                    </div>
                </div>
            </div>
            );
